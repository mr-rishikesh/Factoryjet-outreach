...
/* Example usage inside your generateColdEmail function:
...
if (parsed && (parsed.subject || parsed.body)) {
  // sanitize and return
  return {
    subject: (parsed.subject || "A quick idea for your team").trim(),
    body:
      (parsed.body || "FactoryJet helps teams ship high-performance websites, e-commerce stores, and AI chatbots in as little as 7 days.").replace(/\\n/g, "\n").trim(),
  };
}
