# FactoryJet OutreachCRM - B2B Cold Email Outreach Management System
...
OutreachCRM is a full-stack cold-email outreach management dashboard powering FactoryJet's B2B sales motion. FactoryJet is a SaaS company that ships high-performance websites, e-commerce stores, AI-powered chatbots, AI-enhanced development, and SEO optimization for growing businesses (500+ businesses served, 25+ years of expertise, 7-day delivery). This system functions as a lightweight CRM (similar to Apollo, HubSpot, or Instantly) with the following core capabilities:

- **Import** prospect contacts from Apollo CSV exports
- **Manage** contacts with advanced filtering, sorting, searching, and pagination
- **Generate** personalized B2B cold emails using AI (Groq/LLaMA) — pitching FactoryJet's services
...
The system runs FactoryJet's outreach campaigns end-to-end and the architecture is extensible for multi-user or team use.
...
- Prompt instructs AI to write 3-line personalized B2B cold emails on behalf of FactoryJet
- Structure: line 1 — personalized observation about the prospect; line 2 — relevant FactoryJet service angle (web, e-commerce, chatbot, AI-enhanced dev, or SEO) tied to their context; line 3 — soft CTA
- Hard rules: under 80 words, plain text, no signature/links in body (appended separately), prospect-specific subject under 60 chars
...
- Formats the AI-generated body with:
  - Greeting (firstName lastName, or "there" as fallback)
  - AI-generated personalized content
  - FactoryJet credibility paragraph (500+ businesses, 25+ years, 7-day delivery)
  - Signature: "FactoryJet Team", phone (+91 9699977699), website (https://factoryjet.com)
...
2. AI generates a 3-line personalized B2B cold email pitching FactoryJet, with a custom subject line
3. Email body formatted with greeting, AI content, FactoryJet credibility paragraph, and signature
